    ...
    def getStartState(self):
        ...
        for corner in self.corners:
            ...
            if self.startingPosition == corner:
                cornerStates.append((x,y,True))
            else:
                cornerStates.append((x,y,False))
        return (self.startingPosition,tuple(cornerStates))

    def isGoalState(self, state):
        "Returns whether this search state is a goal state of the problem"
        (x,y),cornersEaten = state
        for corner in cornersEaten:
            x,y,eaten = corner
            if not eaten:
                return False
        return True
            ...
            if not self.walls[nextx][nexty]:
                ...
                for corner in corners:
                    ...
                    if (nextx == cx) and (nexty == cy):
                        newcorners.append((cx,cy,True))
                    else:
                        newcorners.append((cx,cy,eaten))
...
def cornersHeuristic(state, problem):
    ...
    h = 0
    under = 0
    for cornerEaten in cornersEaten:
        cx,cy,eaten = cornerEaten
        notEaten = 1 - eaten
...
class AnyFoodSearchProblem(PositionSearchProblem):
    ...
    def isGoalState(self, state):
        ...
        "*** YOUR CODE HERE ***"
        position = self.food.asList()
        return state in position
